...
int main(int argc, char** argv)
{
  ...
  string name_a = string(argv[1]) + ".a";
  string name_b = string(argv[1]) + ".b";
  string name_c = string(argv[1]) + ".c";
  string name_e = string(argv[1]) + ".e";
  string name_i = string(argv[1]) + ".i";
  string name_j = string(argv[1]) + ".j";
  string name_k = string(argv[1]) + ".k";
